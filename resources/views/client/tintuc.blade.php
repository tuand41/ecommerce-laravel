...
<div class="col-xs-12 ">
    ...
    <div class="content-new row">
        ...
        <div class="content-box col-md-8">
            <div class="new-title"><a href="{{ route('chi-tiet-bai-viet', $p->id)}}">{{ $p->name }}</a> </div>
            <div class="new-sub-title"><i class="far fa-calendar-alt"></i><span>
                    {{ date('d/m/Y H:i',strtotime($p->created_at)) }}</span>
            </div>
            <div class="new-des">
                <p>
                    {{ $p->content }}
