						...
						<div class="thumbnail">
							...
							<div class="caption ">
								...
								<div class="row" style="margin-left: 1px">
									<a href="{{ asset('detail/'.$h->id_sp.'/'.$h->slug_sp.'.html') }}" class="btn btn-default " role="button">Chi Tiết</a>
									<a href="{{ asset('giohang/them/'.$h->id_sp) }}" class="btn btn-primary " role="button">Mua Ngay</a>
								</div>								
							</div>
						</div>
					</div>
