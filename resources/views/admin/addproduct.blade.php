                            ...
                            <div class="col-xs-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text"
                                        value="Sạc, Tai nghe, Sách hướng dẫn, Cáp, Cây lấy sim, Ốp lưng"
                                        name="accessories" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Bảo hành</label>
                                    <input required type="text"
                                        value="Bảo hành chính hãng 12 tháng. 1 đổi 1 trong 1 tháng nếu lỗi"
                                        name="warranty" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Khuyến mãi</label>
                                    <input required type="text" value="Phiếu mua hàng trị giá 400.000đ "
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" value="Chính 25 MP & Phụ 8 MP, 5 MP" name="camsau"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>CPU</label>
                                ...
                                <div class="form-group">
                                    <label>Thẻ nhớ</label>
                                    <input required type="text" value="MicroSD, hỗ trợ tối đa 512 GB" name="thenho"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Thẻ sim</label>
                                    <input required type="text" value="2 Nano SIM, Hỗ trợ 4G" name="thesim"
                                        class="form-control">
                                </div>
