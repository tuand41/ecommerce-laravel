								...
								<table class="table table-bordered" style="margin-top:20px;">				
									...
									<tbody style="vertical-align: middle;">										
										...
										<tr>
											...
											<th style="vertical-align: middle;">{{ number_format($b->totall,0,',','.') }} VND</th>
											...
											<th style="vertical-align: middle;">
												...
												<a href="{{ asset('admin/bill/delete/'.$b->id_bill) }}" class="btn btn-warning"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
												<a href="{{ asset('admin/bill/show/'.$b->id_bill) }}" class="btn btn-info"><i class="fa fa-eye" aria-hidden="true"></i></a>
											</th>
										</tr>
										@endforeach						
									</tbody>
