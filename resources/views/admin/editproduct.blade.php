                            ...
                            <div class="col-xs-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <select required name="status" class="form-control">
                                        <option value="1" @if ($sanpham->status==1)
                                            {{-- expr --}}
                                            selected
                                            @endif>
                                            Còn Hàng
                                        </option>
                                        <option value="0" @if ($sanpham->status==0)
                                            {{-- expr --}}
                                            selected
                                            @endif>
                                            Hết hàng
                                ...
                                <div class="form-group">
                                    ...
                                    <select required name="cate" class="form-control">
                                        ...
                                        {{-- expr --}}
                                        <option value="{{ $dm->id_danhmuc }}" @if ($sanpham->sp_danhmuc ==
                                            $dm->id_danhmuc)
                                            {{-- expr --}}
                                            selected
                                            @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    checked
                                    @endif>
                                    Không: <input type="radio" name="featured" value="0" @if ($sanpham->sp_noibat == 0)
                                    checked
                                    @endif>
                                </div>
                                <div class="form-group">
